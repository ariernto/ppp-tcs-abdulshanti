      ...
      <tr>
        <td style="padding:20px 40px 20px 40px;">
          ...
          <p style="color:#666666;font-size:14px;font-weight: 400;margin-bottom: 20px;margin-top: 10px; font-family: 'Roboto', sans-serif;line-height: 24px;">
            You recently requested to reset your password for your pacificpalmsproperty account.
          </p>
          <p style="color:#666666;font-size:14px;font-weight: 400;margin-bottom: 20px;margin-top: 10px; font-family: 'Roboto', sans-serif;line-height: 24px;">
            Please enter this otp below to reset your password.
          </p>
          <center><span style="background-color:#348393;color:ghostwhite;padding:10px;border-radius:3px;font-size: 36px">{{ $data['otp'] }}</span></center>
          <p style="margin-top: 30px;font-size: 12px;color: #D9453A;font-family: 'Roboto', sans-serif; margin-bottom: 0px;">If you did not request a password reset, please ignore the email.</p>
